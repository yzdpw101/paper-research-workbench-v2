...
| 步骤 | 脚本 | 说明 |
|------|------|------|
| 搜索 | `*-search.js` | 获取标题+摘要片段 |
| 详情 | `*-detail.js` | 获取完整摘要、作者、DOI 等 |
| 并行详情 | `parallel-detail.js` | 多篇论文同时获取详情 |
| 下载 | `*-download.js` | 下载 PDF |
| 并行下载 | `parallel-download.js` | IEEE 多篇同时下载 |
| 批量下载 | `*-batch-download.js` | 多篇打包下载 |
